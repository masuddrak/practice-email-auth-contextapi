    ...
    return (
        <div>
            <div className="space-y-12 dark:bg-gray-100 dark:text-gray-800">
                ...
                <section ref={ref} style={{ background: inView ?"green":"blue"}} className="py-8 transition-all">
                    ...
                    <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row">
                        ...
                        <div className="flex flex-col justify-center pt-6 lg:pt-0">
                            <div className="flex justify-center space-x-4">
                                <a rel="noopener noreferrer" href="#" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-violet-600 dark:text-gray-50">
